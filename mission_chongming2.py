...
conn4=redis.Redis(db=4)
#清空redis 4数据库
for elem in conn4.keys():
    conn4.delete(elem)
conn4.set('lane', 0)
conn4.set('zone',0)
conn4.set('person_id', 0)
...
tracker4 = DeepSort(cfg.DEEPSORT.REID_CKPT,
                    max_dist=cfg.DEEPSORT.MAX_DIST, min_confidence=cfg.DEEPSORT.MIN_CONFIDENCE,
                    nms_max_overlap=cfg.DEEPSORT.NMS_MAX_OVERLAP, max_iou_distance=cfg.DEEPSORT.MAX_IOU_DISTANCE,
                    max_age=cfg.DEEPSORT.MAX_AGE, n_init=cfg.DEEPSORT.N_INIT, nn_budget=cfg.DEEPSORT.NN_BUDGET,
                    use_cuda=True)
...
def main():
    ...
    line2 = ((0, 0), (0, 0))
    screenshot = [345, 1080, 0, 1920]
    url2 = r'rtsp://admin:xike123456@fanmaoyang.kmdns.net:58091/stream1'
    qmap['2'] = conn2
    ...
    line2 = ((0, 0), (0, 0))
    screenshot = [345, 1080, 0, 1920]
    url3 = r'rtsp://admin:xike123456@fanmaoyang.kmdns.net:58097/stream1'
    qmap['3'] = conn3
    ...
    line2 = ((0, 0), (0, 0))
    screenshot = [345, 1080, 0, 1920]
    url4 = r'rtsp://admin:xike123456@fanmaoyang.kmdns.net:58093/stream1'
    qmap['4'] = conn4
    go4 = threading.Thread(target=hardwork, name='stream4',
                           args=('work4', det, tracker4, url4, conn4, line1, line2, screenshot))
    go4.start()
